...
export default function Index() {
  ...
  return (
    <div className={`min-h-screen overflow-x-hidden transition-colors duration-300 
      ...
      {/* Hero Section */}
      <section className="container mx-auto px-4 py-16 md:py-20 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2 flex justify-center animate-slide-in" style={{ animationDelay: '0.2s' }}>
          <div className="relative w-80 h-80">
            {/* Decorative circles */}
            <div className="absolute inset-0 bg-blue-500/10 rounded-full blur-3xl"></div>
            
            {/* Rickshaw illustration can be added here */}
      ...
      <section className="py-16 container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
          What Our <span className="text-blue-500">Riders Say</span>
        </h2>
      ...
      <section className={`py-16 ${isDarkMode ? 'bg-black/20' : 'bg-white/40'}`}>
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
            Cities We <span className="text-blue-500">Cover</span>
          </h2>
