...
export default function Dashboard() {
  ...
  return (
    <div className="relative min-h-screen transition-colors duration-200 flex flex-col">
      <Navbar />
      {/* Glass morph animated background */}
      ...
      <main className="container mx-auto px-4 pt-24 flex-1 z-10 flex flex-col justify-center">
        <div className="mb-8 animate-fade-in flex flex-col md:flex-row md:items-end justify-between">
          <div>
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 via-blue-400 to-purple-400 bg-clip-text text-transparent dark:from-blue-400 dark:via-blue-200 dark:to-purple-200">
              Dashboard
            </h1>
          ...
          {/* Theme toggle for desktop, Profile already left in Navbar */}
        </div>
