      ...
      <main className="container mx-auto px-4 pt-20 md:pt-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="animate-slide-in" style={{ animationDelay: '0.1s' }}>
            <h2 className="text-xl font-semibold text-white mb-4 flex items-center">
              <Calendar className="mr-2 h-5 w-5 text-[#4F8EF7]" />
            ...
            <div className="space-y-4">
              ...
              {rides.filter(ride => ride.status === 'pending').length === 0 && (
                <div className="flex flex-col items-center justify-center py-12 px-6 rounded-2xl bg-[#18203380] backdrop-blur-md border border-[#4F8EF7]/10">
                  <MapPin className="h-12 w-12 text-[#4F8EF7]/40 mb-3" />
                  <p className="text-gray-400 text-center text-lg">No available rides</p>
                  <p className="text-gray-500 text-center text-sm mt-1">Request a new ride to get started</p>
                  <Button 
                    className="bg-[#4F8EF7] hover:bg-[#4F8EF7]/90 mt-6 rounded-xl shadow-lg shadow-blue-900/20"
                    onClick={() => setIsRequestModalOpen(true)}
                  >
                    <MapPin className="mr-2 h-4 w-4" />
                    Request Ride
